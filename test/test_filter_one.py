...
class TestFilterOne(tcore.TCore):
    ...
    def test_filter_one_raises_error_if_no_cells_match(self):
        self.assertRaisesWithMessage(
            ...
            (
                "We expected to find one cell containing the string "
                "'I DO NOT EXIST', but we found none."
            ),
            "I DO NOT EXIST",
        )
    ...
    def test_filter_one_raises_error_if_more_than_one_cell_matches(self):
        try:
            ...
            assert (
                "We expected to find one cell matching the regex "
                "'.*Europe.*', but we found 4: " in str(e)
            )
